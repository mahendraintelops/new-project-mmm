...
import (
	...
	"github.com/mahendraintelops/new-project-mmm/user-service/config"
	restcontrollers "github.com/mahendraintelops/new-project-mmm/user-service/pkg/rest/server/controllers"
